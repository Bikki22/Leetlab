...
const signUpSchema = z.object({
  ...
  name: z.string().min(3, "Name at least of 3 character"),
});
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div className="w-12 h-12 rounded-xl bg-praimary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
